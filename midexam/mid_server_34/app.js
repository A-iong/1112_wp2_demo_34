...
const midprepRouter_xx = require('./routes/midprep_xx');

const apiMidprepRouter_xx = require('./routes/api/apiMidprepRouter_xx');
...
app.use('/midprep_xx', midprepRouter_xx);
app.use('/api/midprep_xx', apiMidprepRouter_xx);
