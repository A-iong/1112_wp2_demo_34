...
import Wrapper from '../assets/wrapper/NavbarMegaResp2_34';

const NavbarMegaResp2_34 = () => {
  return (
    <Wrapper>
            ...
            <div className='header-item item-center'>
              ...
              <nav className='menu'>
                ...
                <ul className='menu-main'>
                  ...
                  <li className='menu-item-has-children'>
                    <a href='#'>
                      Midterm_34 <i className='fas fa-angle-down'></i>
                    </a>
                    <div className='sub-menu single-column-menu'>
                      <ul>
                        <li>
                          <Link to='/mid_static_34'>Static_34</Link>
                        </li>
                        <li>
                          <Link to='/mid_localjson_34'>LocalJson_34</Link>
                        </li>
                        <li>
                          <Link to='/MenuNodeServerPage_34'>Node Server</Link>
                        </li>
                        <li>
                          <Link to='/MenuNodeServerContextPage_34'>
                            Node + Context
                          </Link>
                        </li>
                      </ul>
...
export default NavbarMegaResp2_34;
